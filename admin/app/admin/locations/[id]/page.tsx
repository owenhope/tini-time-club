...
export default async function LocationDetailPage({
  ...
  const errorMessage =
    query.error === "name"
      ? "Enter a location name of 160 characters or fewer."
      : query.error === "address"
        ? "Keep the address to 300 characters or fewer."
        : query.error === "placeId"
          ? "That Google Place ID is invalid or already belongs to another location."
          : null;

  return (
    <AdminShell active="locations">
      <PageHeader
        backLink={{ href: "/admin/locations", label: "Back to locations" }}
      ...
      <div className="grid grid-cols-12 gap-5 px-8 py-6">
        <Panel title="Location details" className="col-span-12 xl:col-span-4">
          ...
          <DataTable
            ...
            empty={
              location.reviews.length === 0 ? (
                <EmptyState>No reviews at this location.</EmptyState>
              ) : null
            }
          >
