-- The inspection function has a RETURNS TABLE region_id output variable.
-- Qualify the CTE region_id reference so PostgreSQL does not confuse it with
-- that PL/pgSQL variable.
