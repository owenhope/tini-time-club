...
export function PassportEntry({ profileId, username }: PassportEntryProps) {
  ...
  return (
    <Pressable
      ...
      accessibilityLabel={`${ownerLabel} Martini Passport, ${displayedPassport?.points == null ? "points unavailable" : `${displayedPassport.points} points`}`}
      onPress={() => {
